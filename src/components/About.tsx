        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I’m a Full-Stack  MERN Developer looking for Job opportunities . Hands-on experience building fast, scalable, and responsive web applications using React.js, Node.js, Express, MongoDB, and PostgreSQL/MySQL. I specialize in creating secure RESTful APIs, implementing modern frontend interfaces, and managing full deployment pipelines using tools like Docker and Git.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-accent-glow font-medium">2</span>
