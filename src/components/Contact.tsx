    ...
    <section id="contact" ref={sectionRef} className="py-20 px-6 relative overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        <div ref={titleRef} className="text-center mb-16">
          ...
          Looking for a passionate developer? Let’s connect and discuss how I can add value to your team.
          </p>
        </div>
          ...
          <div ref={infoRef} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">aviral830351@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 8303514525</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Noida , UttarPradesh</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/AVIRAL-MISHRA-99/" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                  <GithubLogo size={20} className="text-primary-foreground" />
                </a>
                <a href="https://www.linkedin.com/in/aviral-mishra-7b68b0382/" className="w-12 h-12 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
