...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Chatting – Connect &  Share ",
      description: "A real-time chatting web application that enables instant one-to-one communication with a clean UI and smooth user experience, built using modern web technologies.",
      image: "/Images/project-1.jpg",
      tech: ["React", "Node.js", "Express.js", "PostgreSQL", "Tailwind CSS", "TypeScript","Web-Sockets","WebRTC" ],
      liveUrl: "https://chatting-five-olive.vercel.app/",
      githubUrl: "https://github.com/AVIRAL-MISHRA-99/chatting..backend"
    },
    ...
    {
      id: 3,
      title: "Live - A Video Conferencing Tool",
      description: "A live video conferencing web application that enables real-time audio and video communication with a smooth, reliable, and user-friendly experience.",
      image: "/Images/project-3.jpg",
      tech: ["CSS", "React" , "Node" ," MongoDB" , "express", "WebRTC " , "Web_Sockets"],
      liveUrl: "https://apnacollegezoomfrontend.onrender.com",
      githubUrl: "https://github.com/AVIRAL-MISHRA-99/Live..Backend"
    }
