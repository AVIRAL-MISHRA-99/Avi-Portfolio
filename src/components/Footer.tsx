        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/AVIRAL-MISHRA-99/" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                <GithubLogo size={18} className="text-primary-foreground" />
              </a>
              <a href="https://www.linkedin.com/in/aviral-mishra-7b68b0382/" className="w-10 h-10 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
